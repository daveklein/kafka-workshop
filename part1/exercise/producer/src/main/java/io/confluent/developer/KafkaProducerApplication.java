...
public class KafkaProducerApplication {
    ...
    public void runProducer(Properties props) {
        // declare and construct Producer instance
        ...
        try{
            while (keepProducing){
                ...
                //Call producer.send and store the Future<RecordMetadata> as a variable
                
                //Pass that variable to the printMetadata method
